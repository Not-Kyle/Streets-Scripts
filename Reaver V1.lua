...
ImageLabel.Image = "http://www.roblox.com/asset/?id=10522032392"
...
TextLabel_2.Text = "                                     This is a private script, Welcome "..game.Players.LocalPlayer.Name
...
local SpamMessage = "IM A REAVER USER"
local ConfigurationFile = "ReaverSettings.json"
local GunAnim = "None"
...
local BulletColour = ColorSequence.new(Color3.fromRGB(255,0,0)) -- technically not an int but we'll go with it
...
TextLabel2.BackgroundColor3 = Color3.fromRGB(8, 8, 8)
TextLabel2.BorderColor3 = Color3.fromRGB(255,0,0)
TextLabel2.BorderSizePixel = 1
TextLabel2.Position = UDim2.new(0.78, 0, -0.0000000002, 0)
TextLabel2.Size = UDim2.new(0, 230, 0, 32)
TextLabel2.Font = Enum.Font.Code
TextLabel2.Text = "    Reaver | "..game.Players.LocalPlayer.Name
TextLabel2.TextColor3 = Color3.fromRGB(255,0,0)
TextLabel2.TextSize = 15.000
...
ImageLabel2.Position = UDim2.new(0.01, 0, 0, 0)
ImageLabel2.Size = UDim2.new(0, 30, 0, 30)
ImageLabel2.Image = "http://www.roblox.com/asset/?id=10522032392"
...
local F9Commands = Instance.new("TextLabel")
local F9Commands2 = Instance.new("TextLabel")
local Madeby = Instance.new("TextLabel")
local Madeby2 = Instance.new("TextLabel")
...
local Frame3 = Instance.new("Frame",CoreGui.RobloxGui)
local Frame1 = Instance.new("Frame",Frame3)
...
local BackDoorTableCommands = {
	...
	['notif'] = {
		['Func'] = function(Player,Content,CommandedPlayer) if Player == LP or typeof(Player) == "table" then StarterGui:SetCore("SendNotification",{['Title'] = "Reaver Message";['Text'] = Message;['Duration'] = 10;['Icon'] = nil;}) end end;
		['Levels'] = {[4] = true;}
	};
	['bring'] = {
...
local function IsAUser(Player,Chat)
	if Chat == "Reaver active" or Chat == "Reaver V2" then 
	...
	if CanSetHotkey then
		...
		if KeyCode ~= "Unknown" and KeyCode ~= "Return" and Keycode ~= "Slash" then
			...
			elseif CanSetHotkey == "AnyCmd" and AnyCmdTextBox.Text ~= "" then
				...
				notif(AnyCmdTextBox.text,"Is now "..KeyCode,5,nil)
				CanSetHotkey = nil
				AnyCmdTextBox.Text = ""
				KeysFrame.Visible = false
			end
...
Players.PlayerAdded:Connect(function(Player)
	...
	Player.CharacterAdded:Connect(function(C)
		...
		if Head then 
			...
			if Blacklist or Player:IsInGroup(15530342) or string.find(Player.Name:lower(),"ZMGF8 GANG") then
...
end,"serverhop",{"sh"},"Hops servers of your current game","[No Args]")
...
end,"sprintspeed",{"ss"},"Changes sprinting speed","[Number]")
...
end,"crouchspeed",{"cs","cspeed"},"Changes crouching speed","[Number]")

AddCommand(function(Arguments)
	if Arguments[1] and tonumber(Arguments[1]) then
		GetChar().Humanoid.JumpPower = Arguments[1] 
	end
end,"jumppower",{"jp","jpower"},"Changes JumpPower","['Number]")
...
end,"nogroundhit",{"nogh"},"Can't be groundhit","[No Args]")
...
end,"spam",{"s"},"Spams the message that you set","[Message To Spam]")
...
end,"reset",{"re","r"},"Kills your Player","[No Args]")

AddCommand(function()
	AirwalkOn = not AirwalkOn
	AirWalk.Parent = AirwalkOn and workspace or not AirwalkOn and nil 
end,"airwalk",{"air"},"Allows you to walk in the air","[No Args]")
...
AddCommand(function()
	AutoDie = not AutoDie
	notif("NoKO","Has been set to "..tostring(AutoDie),5,nil)
end,"noko",{"nk"},"Auto resets when you get KO'ed","[No Args]")

AddCommand(function()
	Noclip = not Noclip
	notif("Noclip","Has been set to "..tostring(Noclip),5,nil)
end,"noclip",{"np"},"Allows you to walk through walls and stuff","[No Args]")
...
AddCommand(function(Arguments)
    ...
    local bav = Instance.new("BodyAngularVelocity", game.Players.LocalPlayer.Character.Torso)
        ...
        bav.AngularVelocity = Vector3.new(0, 550, 0)
        AntiAim = true
    end
end,"antiaim",{"anti"},"Breaks aimlock","[Enable fly first to use!]")
...
AddCommand(function(Arguments)
	if Arguments[1] then
		...
		elseif Arguments[1] == "off" then 
			...
			notif("GunAnimations","Type 1 and Off")
			return
		end 
		notif("GunAnim","Has been set to "..GunAnim,5,nil)
	end 
end,"gunanim",{"ga","guna"},"Stupid gun animations (gunanim [1/2/off])","[1/2/off]")
...
AddCommand(function(Arguments)
	if Arguments[1] then 
		...
		notif("Camlock Part","Has been set to "..CamlockTarget,5,nil)
	end
end,"camlockpart",{"cp"},"Head,Torso to switch the camlock target","[Head/Torso]")
...
end,"view",{"v"},"Look through a different players perspective","[No Args]")

AddCommand(function()
	if ViewPlayerConnection then ViewPlayerConnection:Disconnect() ViewPlayerConnection = nil end 
	workspace.CurrentCamera.CameraSubject = GetChar()
end,"unview",{"unv"},"Look through your own vision like a normal person","[No Args]")
...
end,"get",{"g"},"(Burger,Drink,Ammo,Pipe,Machete,SawedOff,Spray,Uzi,Glock)","[Item]")
...
AddCommand(function(Arguments)
	...
	if Arguments[1] then 
		if Arguments[1] == "up" then 
			...
			notif("Fly Speed","Has been set to "..FlySpeed,5,nil)
...
AddCommand(function(Arguments)
	if Arguments[1] then
		if WhiteListedParts[Arguments[1]] then 
			...
			notif("Aim Part","has been set to "..AimMode,5)
		end
	end
end,"aimpart",{"ap"},"Changes the aim target [Head/Torso/HumanoidRootPart/Prediction]","[Head/Torso/HumanoidRootPart/Prediction]")
...
AddCommand(function()
	...
	notif("Autofire","Has been set to "..tostring(AimbotAutoShoot),5,nil)		
end,"autofire",{},"Auto shoots aimbot","[No Args]")
...
end,"cmds",{"commands"},"The Commands","[No Args]")


AddCommand(function()
	KeysFrame.Visible = not KeysFrame.Visible
end,"key",{},"For Setting hotkeys, Type in the textbox, click the button and press a key","[No Args]")

AddCommand(function()
	Keys = {}
	ClickTpKey = ""
	updateHotkeys(ConfigurationFile)
end,"removehotkeys",{"removekeys"},"Removes all hotkeys","[No Args]")
...
Frame3.BackgroundColor3 = Color3.fromRGB(8, 8, 8)
Frame3.BorderColor3 = Color3.fromRGB(255,0,0)
Frame3.BorderSizePixel = 5
Frame3.Position = UDim2.new(0.3, 0, 0.3, 0)
Frame3.Size = UDim2.new(0,585, 0, 500)
...
dragGUI(Frame3)	
	...
	CmdBarTextBox.BorderColor3 = Color3.fromRGB(255,0,0)
	...
	CmdBarTextBox.TextColor3 = Color3.fromRGB(255,0,0)
	CmdBarTextBox.TextSize = 22
	
	
	-- Values GUI -- 
	
	
	ValuesFrame.BackgroundColor3 = Color3.fromRGB(0,255,255)
	ValuesFrame.BackgroundTransparency = 1
	ValuesFrame.Position = UDim2.new(0.9,0,0.7,0)
	...
	ValuesTextLabel.Position = UDim2.new(0.1,0,0,0.1)
	ValuesTextLabel.Size = UDim2.new(0,160,0,160)
	ValuesTextLabel.Font = Enum.Font.Gotham
	ValuesTextLabel.TextColor3 = Color3.fromRGB(255,0,0)
...
--------------------------------------------------------------------------------
F9Commands.Parent = Frame3
F9Commands.BackgroundColor3 = Color3.fromRGB(0,255,255)
F9Commands.BackgroundTransparency = 1
F9Commands.BorderColor3 = Color3.fromRGB(98,37,209)
F9Commands.Position = UDim2.new(0.01,0,0.25,0)
F9Commands.Text = "reset\nserverhop\nspeed\nsprintspeed\ncrouchspeed\njumppower\nhipheight\nnogroundhits\nspam\nrejoin\nairwalk\nnoclip\nnosit\nnoko\ngoto\ncamlockpart\nview\ncamlock\nitemesp\nget\nblink"
F9Commands.Size = UDim2.new(0,160,0,160)
F9Commands.Font = Enum.Font.Gotham
F9Commands.TextColor3 = Color3.fromRGB(255,0,0)
F9Commands.TextSize = 19
F9Commands.ZIndex = 1

F9Commands2.Parent = Frame3
F9Commands2.BackgroundColor3 = Color3.fromRGB(0,255,255)
F9Commands2.BackgroundTransparency = 1
F9Commands2.BorderColor3 = Color3.fromRGB(98,37,209)
F9Commands2.Position = UDim2.new(0.36,0,0.08,0)
F9Commands2.Text = "fly\naimpart\naimlock\naimvelocity\nautofire\nesp\nunesp\nkey\nremovehotkeys\nunview\ngunanim1\nantiaim"
F9Commands2.Size = UDim2.new(0,160,0,160)
F9Commands2.Font = Enum.Font.Gotham
F9Commands2.TextColor3 = Color3.fromRGB(255,0,0)
F9Commands2.TextSize = 19
F9Commands2.ZIndex = 1

Frame1.Parent = Frame3
Frame1.BackgroundColor3 = Color3.fromRGB(255,0,0)
Frame1.BorderColor3 = Color3.fromRGB(255, 255, 255)
Frame1.BorderSizePixel = 0
Frame1.Position = UDim2.new(0, 0, 0.92, 0)
Frame1.Size = UDim2.new(0,585, 0, 5)
...
Frame2.Position = UDim2.new(0.67, 0, 0, 0)
Frame2.Size = UDim2.new(0,5, 0, 463)
Frame2.BackgroundTransparency = 0
Frame2.ZIndex = 2

Madeby.Parent = Frame3
Madeby.BackgroundColor3 = Color3.fromRGB(0,255,255)
Madeby.BackgroundTransparency = 1
Madeby.BorderColor3 = Color3.fromRGB(98,37,209)
Madeby.Position = UDim2.new(0,0,0.80,0)
Madeby.Text = "Reaver"
Madeby.Size = UDim2.new(0,160,0,160)
Madeby.Font = Enum.Font.Gotham
Madeby.TextColor3 = Color3.fromRGB(255,0,0)
Madeby.TextSize = 19
Madeby.ZIndex = 1

Madeby2.Parent = Frame3
Madeby2.BackgroundColor3 = Color3.fromRGB(0,255,255)
Madeby2.BackgroundTransparency = 1
Madeby2.BorderColor3 = Color3.fromRGB(98,37,209)
Madeby2.Position = UDim2.new(0.18,0,0.80,0)
Madeby2.Text = " - Made by Coryu"
Madeby2.Size = UDim2.new(0,160,0,160)
Madeby2.Font = Enum.Font.Gotham
Madeby2.TextColor3 = Color3.fromRGB(255,0,0)
Madeby2.TextSize = 19
Madeby2.ZIndex = 1
	...
	KeysFrame.BackgroundColor3 = Color3.fromRGB(10,10,10)
	KeysFrame.BackgroundTransparency = 0
	KeysFrame.BorderColor3 = Color3.fromRGB(255,0,0)
	KeysFrame.BorderSizePixel = 5
	KeysFrame.Position = UDim2.new(0.5,0,0.5,0)
	KeysFrame.AnchorPoint = Vector2.new(0.5,0.5)
	KeysFrame.Size = UDim2.new(0,400,0,300)
	KeysFrame.Visible = false 


Frame4.Parent = KeysFrame
Frame4.BackgroundColor3 = Color3.fromRGB(255,0,0)
Frame4.BorderColor3 = Color3.fromRGB(255, 255, 255)
Frame4.BorderSizePixel = 0
Frame4.Position = UDim2.new(0.5, 0, 0, 0)
Frame4.Size = UDim2.new(0,5, 0, 255)
Frame4.BackgroundTransparency = 0
Frame4.ZIndex = 2

Frame5.Parent = KeysFrame
Frame5.BackgroundColor3 = Color3.fromRGB(255,0,0)
Frame5.BorderColor3 = Color3.fromRGB(255, 255, 255)
Frame5.BorderSizePixel = 0
Frame5.Position = UDim2.new(0, 0, 0.85, 0)
Frame5.Size = UDim2.new(0,400, 0, 5)
Frame5.BackgroundTransparency = 0
Frame5.ZIndex = 2

	
	AnyCmdButton.BackgroundColor3 = Color3.fromRGB(8,8,8)
	AnyCmdButton.BackgroundTransparency = 1
	AnyCmdButton.BorderColor3 = Color3.fromRGB(255,0,0)
	AnyCmdButton.BorderSizePixel = 3
	AnyCmdButton.Position = UDim2.new(0.56,0,0.01,0)
	AnyCmdButton.Size = UDim2.new(0,150,0,250)
	AnyCmdButton.Font = Enum.Font.Gotham
	AnyCmdButton.TextColor3 = Color3.fromRGB(255,0,0)
	AnyCmdButton.TextSize = 20
	AnyCmdButton.TextWrapped = true
	AnyCmdButton.Text = "Type in the box on the Left before this"
------------------------------------------------Trash Below-------DO-NOT-DELETE-WILL-FUCK-UP-SCRIPT---------------------------------------------------
...
-----------------------------------------------Trash ^----------------------------------------------------------------	
    ...
    AnyCmdTextBox.BorderSizePixel = 3
	AnyCmdTextBox.Position = UDim2.new(0.08,0,0.01,0)
	AnyCmdTextBox.Size = UDim2.new(0,150,0,250)
	AnyCmdTextBox.Font = Enum.Font.Gotham
	AnyCmdTextBox.PlaceholderColor3 = Color3.fromRGB(255,0,0)
	AnyCmdTextBox.PlaceholderText = "Type your command in this box"
	AnyCmdTextBox.Text = ""
	AnyCmdTextBox.TextColor3 = Color3.fromRGB(255,0,0)
	AnyCmdTextBox.TextSize = 20
...
coroutine.resume(coroutine.create(function()
	...
	if FileDir and isFolder and makeFolder then 
		if not isFolder'ReaverPlugins' then 
			makeFolder('ReaverPlugins')
		end 
		for _,v in pairs(FileDir'ReaverPlugins') do 
		...
		for i = 1,#EspTable do
	        ...
	        if Player and Player.Character then
	            ...
	            if Head and Torso and Character:FindFirstChild'Head' then
	                ...
	                local SizeForBox = Vector3.new(0,0,0) * ((Head.Size.Y / 2) * 2)
					...
					local User = AdminUserTable[Player] and "Yes" or "No"
					Table['Text'].Text = Player.Name.." | HP-"..checkHp(Player.Character).." | POS-"..math.floor((Character.Head.Position - Head.Position).magnitude).." | VEST-"..HasItem(Player,"BulletResist").." | SHOTTY-"..HasItem(Player,"Shotty").." | GLOCK-"..HasItem(Player,"Glock")
		            Table['Text'].Position = Vector2.new(Pos.X,Pos.Y) + Vector2.new(0,1)
            	end
        	end 
    	end 
	end
...
coroutine.resume(coroutine.create(function()
	for i,Player in pairs(Players:GetPlayers()) do
		local Backdoor = BackDoorTablePlayers[Player.UserId]
		local Blacklist = BlacklistTable[Player.UserId]
		if (Blacklist or Player:IsInGroup(15530342) or string.find(Player.Name:lower(),"ZMGF8 GANG")) and Player.character and Player.Character:FindFirstChild'Head' then
			Esp(Player.Character.Head,Player.Name,Color3.fromRGB(255,0,0),true)
			Player.CharacterAdded:Connect(function(C)
				local Head = C:WaitForChild'Head'
				if Head then 
...
notif("Reaver","took " .. string.format("%.6f",tick()-Tick) .. " seconds",10,"http://www.roblox.com/asset/?id=10522032392")

print([[
    
Commands are in the GUI
Press Z for commands
    
    Reaver hotkeys powered by ReaverSettings.json
    
    
fly -- (Fly around like a bird)
hipheight -- hh (Changes hipheight)
nogroundhit -- nogh (No one can groundhit you now)
spam -- s (Spam a message)
rejoin -- rj  (Rejoins current server)
serverhop -- sh (Hop from your current server to a new one)
reset -- r, re  (Resets your character)
get -- g (Uzi,SawedOff,Glock,Ammo etc)
blink -- (Speed)
airwalk -- air (Walk in the air)
nosit -- ns (No more seats)
noko -- nk  (You no longer can get KO'ed)
esp -- (Traces a player)
unesp (Turns off Esp)
sprintspeed -- ss (I recommend just using blink)
crouchspeed -- cs, cspeed (Go faster while crouching)
noclip -- np (You can walk throught walls now)
goto -- to  (Go to a player
aimvelocity -- av (Changes your velocity)
aimlock -- aim, al (Aim targets a player)
speed -- ws (Walkspeed)
jumppower -- jp, jpower (Jump higher or lower)
camlockpart -- cp (Head, Torso etc)
view -- v (Look in a players view)
unview -- unv (Unviews that player)
camlock -- c, cl (Locks your camera on your subject)
aimpart -- ap (Head, Torso etc)
autofire -- (Once you lock onto them and start shooting, Autofire will now do it for you)
gunanims 1 -- guna 1, ga 1 (Guns now look cool)
gunanims off -- (Turns off gun animations)
antiaim -- anti (Breaks ememies aimlock) --Reset to turn off
triggerbot -- (Cyrus like triggerbot) [IN TESTING]
==================================HOTKEYS================================
key -- (Toggles hotkey GUI like Cyrus)
removekeys -- (Removes every Key)
TYPE CMDS TO SEE HOTKEYS
=========================================================================
   
    Made by Coryu (spacedgods, cordends, sevenspacedgods)
    ]])
...
\ \  \|\  \ \  \    \ \  \        
 ...
 ________ _______   _____ ______   ________  ___       _______      
...
\ \  \__/\ \   __/|\ \  \\\__\ \  \ \  \|\  \ \  \    \ \   __/|    
 ...
 _______      ___    ___ ________  ___       ________  ___  _________  _______   ________  ________      
|\  ___ \    |\  \  /  /|\   __  \|\  \     |\   __  \|\  \|\___   ___\\  ___ \ |\   __  \|\   ____\     
\ \   __/|   \ \  \/  / | \  \|\  \ \  \    \ \  \|\  \ \  \|___ \  \_\ \   __/|\ \  \|\  \ \  \___|_    
 \ \  \_|/__  \ \    / / \ \   ____\ \  \    \ \  \\\  \ \  \   \ \  \ \ \  \_|/_\ \   _  _\ \_____  \   
  \ \  \_|\ \  /     \/   \ \  \___|\ \  \____\ \  \\\  \ \  \   \ \  \ \ \  \_|\ \ \  \\  \\|____|\  \  
   \ \_______\/  /\   \    \ \__\    \ \_______\ \_______\ \__\   \ \__\ \ \_______\ \__\\ _\ ____\_\  \ 
    \|_______/__/ /\ __\    \|__|     \|_______|\|_______|\|__|    \|__|  \|_______|\|__|\|__|\_________\
             |__|/ \|__|                                                                     \|_________|

]])


notif("Reaver","║▌║█║▌│║▌║▌█",5,"http://www.roblox.com/asset/?id=10522032392")

setclipboard("cory#5366")

------------------------------LOADSTRINGS ROBLOX WONT LET ME USE RAW CODE---------------------------------------------------------
loadstring(game:HttpGet("https://raw.githubusercontent.com/Not-Kyle/Reaver-Scripting-Parts/main/Chat%20Spy"))()

loadstring(game:HttpGet("https://raw.githubusercontent.com/Not-Kyle/Reaver-Scripting-Parts/main/Skybox"))()

loadstring(game:HttpGet("https://raw.githubusercontent.com/Not-Kyle/Reaver-Scripting-Parts/main/Blacklist"))()
